...
inpu.insert(0,"Write Somethings...")
inpu.pack()
print(inpu.get())
...
can.create_oval(20 , 100 , 200 , 30)
can.create_rectangle(20 , 100 , 200 , 30)
can.pack()

#PhotoImage
img = PhotoImage(file=r"D:\CLASS\Python - 201\tk\1.png")
...
labelf = Label(fram, text="نام خود را وارد کنید:")
labelf.pack(pady=10)
